                ...
                <div className={`lg:w-3/5 lg:m-auto  flex flex-col justify-center ${styles.height}`}>
                    ...
                    <form className={`mb-10`}>
                        <label className={`block mb-4`}>
                            <input type="text" placeholder='Enter your username' className={`outline-none block w-full p-2 border-solid border-2 border-black rounded-lg`} />
                        </label>
                        <label className={`block mb-4`}>
                        ...
                        <label className={`block mb-3`}>
                         ...
                         <input type="submit" value="Sign Up" className={`cursor-pointer mt-10 block w-full p-2 bg-slate-300 rounded-lg hover:bg-black hover:text-white `} />
