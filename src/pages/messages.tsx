            ...
            <main className={` md:w-8/12 mx-auto `}>
                ...
                <div className="fixed w-full h-full top-0 left-0 bg-slate-900 bg-opacity-50 flex items-center justify-center ">
                    <div className="bg-gray-100 rounded max-w-sm w-full pb-2">
                        <p className="p-2 text-center font-medium  border-b-2 border-gray-200">New message</p>
                        ...
                        <div className="mx-2 mt-2 ">
                            <button disabled={!selectUser} className={`w-full rounded py-2 ${selectUser ? "bg-violet-700  text-white" :"bg-violet-300  text-white"} `}>chat</button>
                        </div>
                    </div>
                </div>
            </main>
